...
@Component({
  selector: 'app-profil-preneur',
  templateUrl: './profil-preneur.component.html',
  styleUrls: ['./profil-preneur.component.scss']
})
export class ProfilPreneurComponent implements OnInit {
